...
namespace gymnasiearbete
{
    public class Players
    {
        ...
        public Players(Texture2D img, Vector2 pos, float scale, string playername, int netvalue, int gamepiececolor, int selectedfarm, int seedselection, int squareposition, int beetA, int potaA, int wheaA, int carrA, bool done)
        {
